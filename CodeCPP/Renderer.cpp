...
void DrawBoundingBox(float minVal, float maxVal) {
    glLineWidth(1.0f);
    glColor4f(0.3f, 0.3f, 0.4f, 0.5f);
    glBegin(GL_LINES);
    glVertex3f(minVal, minVal, minVal); glVertex3f(maxVal, minVal, minVal);
    glVertex3f(minVal, maxVal, minVal); glVertex3f(maxVal, maxVal, minVal);
    glVertex3f(minVal, minVal, maxVal); glVertex3f(maxVal, minVal, maxVal);
    glVertex3f(minVal, maxVal, maxVal); glVertex3f(maxVal, maxVal, maxVal);
    glVertex3f(minVal, minVal, minVal); glVertex3f(minVal, maxVal, minVal);
    glVertex3f(maxVal, minVal, minVal); glVertex3f(maxVal, maxVal, minVal);
    glVertex3f(minVal, minVal, maxVal); glVertex3f(minVal, maxVal, maxVal);
    glVertex3f(maxVal, minVal, maxVal); glVertex3f(maxVal, maxVal, maxVal);
    glVertex3f(minVal, minVal, minVal); glVertex3f(minVal, minVal, maxVal);
    glVertex3f(maxVal, minVal, minVal); glVertex3f(maxVal, minVal, maxVal);
    glVertex3f(minVal, maxVal, minVal); glVertex3f(minVal, maxVal, maxVal);
    glVertex3f(maxVal, maxVal, minVal); glVertex3f(maxVal, maxVal, maxVal);
    glEnd();
}
...
int Renderer() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        DrawBoundingBox((float)g_range_min, (float)g_range_max);

        double clipPlanes[6][4] = {
            { 1.0,  0.0,  0.0, -g_range_min },
            {-1.0,  0.0,  0.0,  g_range_max },
            { 0.0,  1.0,  0.0, -g_range_min },
            { 0.0, -1.0,  0.0,  g_range_max },
            { 0.0,  0.0,  1.0, -g_range_min },
            { 0.0,  0.0, -1.0,  g_range_max }
        };
        ...
        glClipPlane(GL_CLIP_PLANE4, clipPlanes[4]);
        glClipPlane(GL_CLIP_PLANE5, clipPlanes[5]);
